...
public class TopupAmountResponseDao {
	...
	public TopupAmountResponseDao() {

	}

	public TopupAmountResponseDao(Double topupAmount, String ticketId) {
		super();
		this.topupAmount = topupAmount;
		this.ticketId = ticketId;
	}

	public TopupAmountResponseDao(int topupAmountId, Double topupAmount, Date date, String time, String ticketId) {
		super();
