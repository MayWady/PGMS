...
public class MembershipResponseDao {
	...
	public MembershipResponseDao() {

	}

	public MembershipResponseDao(String memberId, String memberName, double discount) {
		super();
	...
	public MembershipResponseDao(String memberId, double discount) {
		super();
		this.memberId = memberId;
		this.discount = discount;
	}

	public MembershipResponseDao(String memberId, String memberName, String phone, Date validFrom, Date validTo,
