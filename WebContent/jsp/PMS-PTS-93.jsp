...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">PLaything Status Update</h2>
					</div>
				</div>
	...
	<section id="content">
		...
		<form:form id="contactform" action="" method="post" role="form"
			modelAttribute="playthingStatus">
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						...
						<input type="submit" class="btn btn-color" value="Confirm"
							formaction="playthingStatusUpdate" /> <input type="submit"
							class="btn btn-color" value="Cancel"
							formaction="setupPlaythingStatusUpdate" />
					</p>
				</div>
			</div>
		</form:form>
