...
<section id="inner-headline">
    ...
    <section id="content">
		...
		<form:form id="contactform" action="confirmMembershipStatusUpdate" method="post" role="form" name="listForm" modelAttribute="membershipStatus">
			...
			<div class="row" style="margin-left: 200px;">
				...
				<div class="row">
					...
					<input type="submit" class="btn btn-color" value="Delete" onclick="checkDelete()" />
					 <input type="submit" class="btn btn-color" value="Back" formaction="setupMembershipStatusAdd" />
					</p>
				</div>
			</div>
		</form:form>
  ...
  <script src="resources/js/custom.js"></script>
   ...
   <script type="text/javascript">
	...
	if (con) {
		document.listForm.action = "deleteMembershipStatus";
		document.action.submit;
		}else{
			document.listForm.action = "setupMembershipStatusUpdate";
			document.action.submit;
		}
	}
</script>
