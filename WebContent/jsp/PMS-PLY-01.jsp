...
<body>
			...
			<div class="row">
				<div class="span4">
					<div class="inner-heading">
						<h2 align="center">${sessionScope.bean.playthingName } Play</h2>
	...
	<section id="content">
		<form:form id="contactform" action="addPlay" method="post" role="form"
			modelAttribute="play">
			...
			<div class="row" style="margin-left: 200px;">
				Price - ${sessionScope.bean.price }
				<div class="row">
					<div class="span0 field form-group">Ticket ID:</div>
		...
		<table class="table table-striped"
			...
			<c:forEach var="item" items="${playList}" varStatus="mycount">
				<tr>
					<td>${mycount.count}</td>
					<td>${item.ticketId}</td>
					<td>${item.time}</td>
		...
		<div class="row" style="margin-left: 200px;">
			...
			<p style="margin-left: 5px;">
				<form:form>
					<input type="submit" class="btn btn-color" value="Run"
						formaction="run" />
				</form:form>
		</div>
	</section>
