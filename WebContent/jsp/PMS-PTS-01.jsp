...
<section id="inner-headline">
        ...
        <div class="row">
          <div class="span12">
            <div class="inner-heading">
              <h2 align="center"">Plaything Status Register</h2>
    ...
    <section id="content">
           ...
           <form:form id="contactform" action="confirmPlaythingStatusAdd" method="post" role="form"  modelAttribute="playthingStatus">
			<div class="row" style="margin-left:200px;">
                <div class="row">
                	
                	<div class="span0 field form-group">Plaything Status Name:*</div>
            ...
            <table class="table table-striped" style="width: 50%; margin-left: 200px;">
            	<tr>
            		<td>No</td>
            		<th>Plaything Status Name</th>
            		<th>Action</th>
            	</tr>
            	
            	<c:forEach var="item" items="${playthingStatusList}" varStatus="mycount">
            	<tr>
   					<td>${mycount.count}</td>
   					<td>${item.name}</td>
   					<td><a href="setupPlaythingStatusUpdate?id=${item.id}&name=${item.name}">Edit</a></td>
