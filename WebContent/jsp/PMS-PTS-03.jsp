...
<section id="inner-headline">
        ...
        <div class="row">
          <div class="span12">
            <div class="inner-heading">
              <h2 align="center">Plaything Status Detail</h2>
            </div>
          </div>
    ...
    <section id="content">
		...
		<form:form id="contactform" action="confirmPlaythingStatusUpdate" method="post" role="form" name="listForm" modelAttribute="playthingStatus">
			...
			<div class="row" style="margin-left: 200px;">
				...
				<div class="row">
					...
					<input type="submit" class="btn btn-color" value="Delete" onclick="checkDelete()" />
					 <input type="submit" class="btn btn-color" value="Back" formaction="setupPlaythingStatusAdd" />
					</p>
				</div>
			</div>
		</form:form>
  ...
  <script src="resources/js/custom.js"></script>
   ...
   <script type="text/javascript">
	...
	if (con) {
		document.listForm.action = "deletePlaythingStatus";
		document.action.submit;
		}else{
			document.listForm.action = "setupPlaythingStatusUpdate";
			document.action.submit;
		}
	}
</script>
