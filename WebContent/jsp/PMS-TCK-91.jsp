			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Ticket Confrim</h2>
					</div>
				</div>
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Confirm"
							formaction="addTicket" /> <input type="submit"
							class="btn btn-color" value="Cancel" formaction="setupTicketAdd" />
					</p>
				</div>
			</div>
		</form:form>
