...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Plaything Categories Detail</h2>
					</div>
				</div>
	...
	<section id="content">
		...
		<form:form id="contactform" modelAttribute="playthingCategories"
			action="confirmPlaythingCategoriesUpdate" method="post" role="form"
			name="listForm">
				...
				<div class="row">
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Update" /> <input
							...
							formaction="setupPlaythingCategoriesAdd" />
					</p>
				</div>
			</div>
		</form:form>
	...
	<script type="text/javascript">
		function checkDelete() {
			...
			if (con) {
				document.listForm.action = "deletePlaythingCategories";
				document.action.submit;
			} else {
				document.listForm.action = "setupPlaythingCategoriesUpdate";
				document.action.submit;
			}
		}
	</script>
