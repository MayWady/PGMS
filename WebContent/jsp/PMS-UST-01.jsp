...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center"">User Status Register</h2>
	...
	<section id="content">
		...
		<form:form id="contactform" method="post" role="form"
			modelAttribute="userStatus" action="confirmUserStatusAdd">
			<div class="row" style="margin-left: 200px;">
				<div class="row">

					<div class="span0 field form-group">User Status Name:*</div>
		...
		<table class="table table-striped"
			...
			<c:forEach var="item" items="${userStatusList}" varStatus="mycount">
				<tr>
					<td>${mycount.count}</td>
					<td>${item.name}</td>
					<td><a
						href="setupUserStatusUpdate?id=${item.id}&name=${item.name}">Edit</a></td>
