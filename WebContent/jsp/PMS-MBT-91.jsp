			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Member Type Confirm</h2>
				...
				<div class="row">
					<table width="50%" style="margin-left: 30px;">
						...
						<tr>
							...
							<td style="color: #5cb85c" colspan="3">${membertype.description}
						</td>
						</tr>
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Confirm"
							formaction="addMemberType" /> <input type="submit"
							class="btn btn-color" value="Cancel"
							formaction="setupMemberTypeAdd" />
					</p>
				</div>
			</div>
		</form:form>
