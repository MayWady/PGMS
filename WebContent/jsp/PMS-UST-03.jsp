...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">User Status Detail</h2>
					</div>
				</div>
	...
	<section id="content">
		...
		<form:form id="contactform" action="confirmUserStatusUpdate"
			method="post" role="form" name="listForm" modelAttribute="userStatus">
	...
	<script type="text/javascript">
		function checkDelete() {
			...
			if (con) {
				document.listForm.action = "deleteUserStatus";
				document.action.submit;
			} else {
				document.listForm.action = "setupUserStatusUpdate";
				document.action.submit;
			}
		}
	</script>
