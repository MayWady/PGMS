			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Plaything Update Confrim</h2>
					</div>
				</div>
				...
				<div class="row">
					<table width="100%" style="margin-left: 30px;">
						<tr>
							...
							<td>Plaything Name:</td>
							<form:hidden path="playthingName" />
							<td style="color: #5cb85c">${plaything.playthingName}</td>
						</tr>
						<tr>
							<td>Price:</td>
							<form:hidden path="price" />
							<td style="color: #5cb85c">${plaything.price}</td>
							<td>Play Count</td>
							<form:hidden path="playCount" />
							<td style="color: #5cb85c">${plaything.playCount}</td>
						</tr>
						<tr>
							<td>Running Count:</td>
							<form:hidden path="runningCount" />
							<td style="color: #5cb85c">${plaything.runningCount}</td>
							<td>Maintenance Count:</td>
							<form:hidden path="maintenanceCount" />
							<td style="color: #5cb85c">${plaything.maintenanceCount}</td>
						</tr>
						<tr>
							<td>Service Count:</td>
						...
						<tr>
							...
							<td style="color: #5cb85c" colspan="3">${plaything.description}</td>
						</tr>
					</table>
				</div>
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Confirm"
							formaction="playthingUpdate" /> <input type="submit"
							class="btn btn-color" value="Cancel"
							formaction="setupPlaythingUpdate" />
					</p>
				</div>
			</div>
		</form:form>
