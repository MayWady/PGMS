...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">TicketType Status Detail</h2>
					</div>
				</div>
	...
	<section id="content">
		...
		<form:form id="contactform" action="confirmTicketTypeStatusUpdate" method="post" role="form"
			name="listForm" modelAttribute="ticketTypeStatus">
			...
			<div class="row" style="margin-left: 200px;">
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						...
						<input type="submit" class="btn btn-color" value="Back" formaction="setupTicketTypeStatusAdd" />
					</p>
				</div>
			</div>
		</form:form>
	...
	function checkDelete() {
		...
		if (con) {
			document.listForm.action = "deleteTicketTypeStatus";
			document.action.submit;
		} else {
			document.listForm.action = "setupTicketTypeStatusUpdate";
			document.action.submit;
		}
	}
	</script>
