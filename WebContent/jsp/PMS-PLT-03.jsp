...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Plaything Detail</h2>
					</div>
				</div>
	...
	<section id="content">
		...
		<form:form id="contactform" method="post" role="form" name="listForm"
			modelAttribute="plaything" action="confirmPlaythingUpdate">
			...
			<div class="row" style="margin-left: 200px;">
				...
				<div class="row">
					...
					<div class="span4 field form-group">
						Play Count:
						<form:input type="text" path="playCount" />
						<div style="color: red;">
							<form:errors path="playCount" />
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Update"
							formaction="confirmPlaythingUpdate" /> <input type="submit"
							class="btn btn-color" value="Delete" onClick="checkDelete()" />
						<input type="submit" class="btn btn-color" value="Back"
							formaction="setupPlaythingSearch" /> <input type="submit"
							class="btn btn-color" value="Play" formaction="setupPlayAdd" />
	...
	<script type="text/javascript">
		function checkDelete() {
			...
			if (con) {
				document.listForm.action = "deletePlaything";
				document.action.submit;

			} else {
				document.listForm.action = "setupPlaythingUpdate";
				document.action.submit;
			}
		}
	</script>
