...
<link
	href="resources/https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700"
	rel="stylesheet">
...
<body>
	...
	<section id="content">
		...
		<form:form id="contactform" action="confirmTopupAmountUpdate"
			method="post" role="form" name="listForm"
			modelAttribute="topupAmountDetail">
			...
			<div class="row" style="margin-left: 100px;">
				...
				<div class="row">
					...
					<div class="span4 field form-group">
						Total Balance:
						<form:input type="text" path="totalBalance" class="rightAligned" />
						<div style="color: red;">
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Update"
							formaction="confirmTopupAmountUpdate" /> <input type="submit"
							class="btn btn-color" value="Delete"
							onClick="javascript:checkDelete()" /> <input type="submit"
							class="btn btn-color" value="Back"
							formaction="backTopupAmountSearch" />
					</p>
				</div>
			</div>
		</form:form>
	...
	<script type="text/javascript">
		function checkDelete() {
			...
			if (con) {
				document.listForm.action = "deleteTopupAmount";
				document.action.submit;

			} else {
				document.listForm.action = "setupTopupAmountUpdate";
				document.action.submit;
			}
		}
	</script>
