...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Ticket Register</h2>
	...
	<section id="content">
		...
		<form:form id="contactform" action="confirmTicketAdd" method="post"
			role="form" modelAttribute="ticket">

			<div class="row" style="margin-left: 200px;">

				<!-- 	<img alt="QR Code" src="sources/img/QRCode.jpg"
					class="rounded float-left" width="100px" height="100px"
				...
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Register"
							formaction="confirmTicketAdd" />
						<!-- <input type="submit"
							class="btn btn-color" value="Cancel" formaction="PMS-HOM-01.jsp" /> -->
					</p>
				</div>
			</div>
		</form:form>
