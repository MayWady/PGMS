			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Plaything Categories Update Confrim</h2>
					</div>
				</div>
			...
			<div class="row" style="margin-left: 200px;">
				<div class="row">
					<table width="100%" style="margin-left: 30px;">
						<tr>
							<td>Plaything Categories Name:</td>
							<form:hidden path="id" />
							<form:hidden path="name" />
							<td style="color: #5cb85c">${playthingCategories.name}</td>
						</tr>
					</table>
				</div>
				<div class="row">
					...
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Confirm"
							formaction="playthingCategoriesUpdate" /> <input type="submit"
							class="btn btn-color" value="Cancel"
							formaction="setupPlaythingCategoriesUpdate" />
					</p>
				</div>
			</div>
		</form:form>
