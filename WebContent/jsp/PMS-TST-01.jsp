...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Ticket Status Register</h2>
	...
	<section id="content">
		...
		<form:form id="contactform" action="confirmTicketStatusAdd" method="post" role="form"
			...
			<div class="row" style="margin-left: 200px;">
				<div class="row">
					<div class="span0 field form-group">Ticket Status Name*</div>
		...
		<table class="table table-striped"
			...
			<c:forEach var="item" items="${ticketStatusList}" varStatus="mycount">
				<tr>
					<td>${mycount.count}</td>
					<td>${item.name}</td>
					<td><a
						href="setupTicketStatusUpdate?id=${item.id}&name=${item.name}">Edit</a></td>
