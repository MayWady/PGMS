...
<section id="inner-headline">
        ...
        <div class="row">
          <div class="span12">
            <div class="inner-heading">
              <h2 align="center">Play Status Register</h2>
    ...
    <section id="content">
           ...
           <form:form id="contactform" action="confirmPlayStatusAdd" method="post" role="form"  modelAttribute="playStatus">
            ...
            <table class="table table-striped" style="width: 50%; margin-left: 200px;">
            	<tr>
            		<td>No</td>
            		<th>Play Status Name</th>
            		<th>Action</th>
            	</tr>
            	
            	<c:forEach var="item" items="${playStatusList}" varStatus="mycount">
            	<tr>
   					<td>${mycount.count}</td>
   					<td>${item.name}</td>
   					<td><a href="setupPlayStatusUpdate?id=${item.id}&name=${item.name}">Edit</a></td>
