...
<body>
			...
			<div class="row">
				<div class="span12">
					<div class="inner-heading">
						<h2 align="center">Ticket Type Detail</h2>
	...
	<section id="content">
		...
		<form:form id="contactform" method="post" role="form" name="listForm"
			modelAttribute="ticketTypeDetail" action="confirmTicketTypeUpdate">
			...
			<div class="row" style="margin-left: 200px;">
				...
				<div class="row">
					<div class="span4 field form-group">
						...
						Valid From:
						<form:input type="text" path="validFrom" />
						<div style="color: red;">
					...
					<div class="span4 field form-group">
						...
						Valid To:
						<form:input type="text" path="validTo" />
						<div style="color: red;">
				...
				<div class="row">
					<p style="margin-left: 30px;">
						<input type="submit" class="btn btn-color" value="Update" /> <input
							...
							formaction="backTicketTypeSearch" />
					</p>
				</div>
			</div>
		</form:form>
	...
	<script type="text/javascript">
		function checkDelete() {
			...
			if (con) {
				document.listForm.action = "deleteTicketType";
				document.action.submit;

			} else {
				document.listForm.action = "setupTicketTypeUpdate";
				document.action.submit;
			}
		}
	</script>
